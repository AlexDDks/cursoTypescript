...
// Tenemos la información clara y concisa, pero en las tuplas, únicamente tenemos los valores de esas propiedades y es nuestro deber como programadores el memorizar a qué propiedad pertenece cada valor. Podemos notar uqe tenemos una pérdida de información, esto e suna tupla. Si cambiamos la posición de cada elemento de la tupla, entonces podríamos confundirnos sobre qué intenta representar ese valor:
